        ...
        <div className="container-fluid userHtml" id="noPadding">
          ...
          <div className="container text-center themeBlue" id="extra3Padding">
            ...
            <p>
              ...
              treat each of our guests as if they are members of the Tiny
              Miracles Family. Each day is filled with plenty of personal
              interaction, group playtime, love and attention.
            </p>
            <br />
            <Row>
              <Col xs="12" lg="6">
            ...
            <Row>
              <Col sm={12} md={6}>
                ...
                <div style={{ textAlign: "left" }}>
                  <p>
                    <b>Lodging and Daycare: </b>Tiny Miracles Farm is not your
                    typical kennel.&nbsp; Our guests are treated as members of
                    our family. Our accommodations include:
                  </p>
                  <div
                    style={{
                      margin: "auto",
            ...
            <div style={{ textAlign: "left", marginBottom: "40px" }}>
              <div>
                <span>
                  <span>
                    <b>NOTICE: </b>We will need your pet’s license number as
                    well as a proof of the following up to date vaccines: DOGS
                    –&nbsp;Distemper, Parvo, Bordetella and Rabies; CATS –
                    rabies and FVRCP (current within six months). Flea and tick
              ...
              <div>
                ...
                donating a dollar to our rescue. (15 minutes late = $15
                donation)
              </div>
              <div>
              ...
              <div>
                If you have any question or concerns, please contact Kim at
                (215) 997-2844.
              </div>
              <div></div>
              <div>Thank you.</div>
