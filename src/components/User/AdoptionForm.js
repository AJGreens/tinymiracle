      ...
      <Container className="mt-4 themeBlue">
        ...
        <Form ref = {form} onSubmit={handleSubmit} >
          ...
          <p>
            ...
            to determine the best placement for our dogs.{" "}
            <b>The application is not a guarantee of any dog placement.</b>
          </p>
          <Form.Label>
            I agree that I have read and understand the above disclaimer.&nbsp;{" "}
          </Form.Label>
          <Form.Check
            inline
            label=""
