...
export default function FosterApplication() {
  ...
  function sendEmail(){
      ...
      emailjs.sendForm(process.env.REACT_APP_EMAILJS_FOSTER_SERVICE_ID, process.env.REACT_APP_EMAILJS_FOSTER_TEMPLATE_ID, form.current, process.env.REACT_APP_EMAILJS_FOSTER_USER_ID)
      .then((result) => {
          ...
          <Form ref = {form} onSubmit={handleSubmit} >
            ...
            {hasPets && (
              <>
                ...
                >
                  <Form.Label>
                    Please list any more current pets and "other" types from above
                  </Form.Label>
                  <Form.Control
                    as="textarea"
                    rows={3}
                ...
                <Form.Group className="mb-3">
              <Form.Label>
                Do your pets get along with other animals?  Please be specific.
              </Form.Label>
              <Form.Control
                required
                type="text"
            ...
            <Form.Group className="mb-3" controlId="exampleForm.ControlTextarea1">
              <Form.Label>
                Please tell us a little about yourself, your past experience with
                dogs, and why you feel you could provide a good home for a rescue:
              </Form.Label>
              <Form.Control
                as="textarea"
                rows={3}
            ...
            <p>
                Please be advised that Tiny Miracles Rescue covers the cost of food and veterinary care.  Veterinary visits will be
                scheduled through a TMR volunteer and must be approved.  If a crate is needed, one will be supplied for you.  As 
                a foster, you agree to accept the risk of your own animals catching anything contagious from a foster animal.
            </p>
            <Form.Label>
              I agree that I have read and understand the above statement.&nbsp;{" "}
            </Form.Label>
            <Form.Check
              inline
              label=""
