          ...
          <Row id="noMarginExtraPadding">
            ...
            >
              <Row>
                <Col md={2}></Col>
                <Col md={8}>
                  <h3 className="underlineHeading">Many Ways To Give</h3>
                      ...
                      <Col xs={12}>
                        <div className="container">
                          ...
                          <p className="donateP">
                            ...
                            Miracles Rescue. Each time you shop amazon sends us
                            a donation. It doesn’t cost you anything extra.
                          </p>
                        </div>
                      </Col>
                      <Col xs={12}>
                        <div className="container">
                          ...
                          >
                            ...
                            <p className="donateP">
                              Purchase something for Tiny Miracles Rescue
                              Animals from our wish list. It's the most personal
                              way to give!
                            </p>
                          </form>
                        </div>
